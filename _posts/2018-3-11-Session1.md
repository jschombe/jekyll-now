...
![png](Session1_files/Session1_5_0.png)
...
#######################################################################
baseball=pd.read_csv("C:\\Users\\Owner\\Dropbox\\Data_Science_Initiative\\PredictiveModeling_withPython-wi_17\\data\\baseball.dat.txt")
baseball.tail()
```
...
```
    ...
    <ipython-input-1-be6b940a9640> in <module>()
          2 # Demonstration - Plot a Histogram of Hits
          3 #############################################################
    ----> 4 f = plt.figure()
          5 plt.hist(baseball['Hits'], bins=15)
          6 plt.xlabel('Number of Hits')
